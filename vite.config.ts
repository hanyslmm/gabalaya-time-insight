  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        navigateFallbackDenylist: [/^\/auth/, /^\/api/, /functions/, /supabase/],
        runtimeCaching: [
          {
      ...
      manifest: {
        name: 'Employee Timesheet Management System',
        short_name: 'Timesheet HRM',
        description: 'Modern employee timesheet and HR management system',
        theme_color: '#0f172a',
