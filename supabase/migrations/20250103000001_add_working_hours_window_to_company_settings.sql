-- Add working hours window configuration to company_settings table
...
COMMENT ON COLUMN public.company_settings.working_hours_window_enabled IS 'Whether to limit payable hours to the working hours window';
COMMENT ON COLUMN public.company_settings.working_hours_start_time IS 'Start time of the working hours window (e.g., 08:00:00 for 8 AM)';
COMMENT ON COLUMN public.company_settings.working_hours_end_time IS 'End time of the working hours window (e.g., 01:00:00 for 1 AM next day)';
