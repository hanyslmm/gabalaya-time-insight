-- MANUAL MIGRATION SCRIPT FOR PREVENTING OVERLAPPING TIMESHEETS
...
IS 'Prevents overlapping timesheet intervals for the same employee (inclusive bounds).';
...
WHERE conrelid = 'public.timesheet_entries'::regclass
  AND conname IN ('timesheet_positive_duration_chk', 'timesheet_no_overlap_excl');
